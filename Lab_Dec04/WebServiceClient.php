...
if (!is_object($obj) || !property_exists($obj, "result") || $obj->result != "Success") {
  print "No products could be loaded. Try again later.";
  exit;
}

if (property_exists($obj, "data") && is_object($obj->data) && property_exists($obj->data, "productid")) {
  print $obj->data->productid;
}
